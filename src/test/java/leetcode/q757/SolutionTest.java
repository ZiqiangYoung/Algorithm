...
class SolutionTest {
    ...
    void implTest(Solution impl) {
        assertEquals(3, impl.intersectionSizeTwo(
                MyStr.parseTwoDArrayString2TwoDIntArray("[[1, 3], [1, 4], [2, 5], [3, 5]]")
        ));

        assertEquals(5, impl.intersectionSizeTwo(
                MyStr.parseTwoDArrayString2TwoDIntArray("[[1, 2], [2, 3], [2, 4], [4, 5]]")
        ));

        assertEquals(5, impl.intersectionSizeTwo(
                MyStr.parseTwoDArrayString2TwoDIntArray("[[1,3],[3,7],[5,7],[7,8]]")
        ));

        assertEquals(3, impl.intersectionSizeTwo(
                MyStr.parseTwoDArrayString2TwoDIntArray("[[1,2],[0,3],[2,3]]")
        ));
    }
