...
class SolutionTest {
    ...
    void implTest(Solution impl) {
        assertArrayEquals(CommonStr.parse2IntegerArray("[1,null,0,null,1]"),
                TreeNode.leetcodeOutput(impl.pruneTree(TreeNode.leetcodeInput("[1,null,0,0,1]"))));

        assertArrayEquals(CommonStr.parse2IntegerArray("[1,null,1,null,1]"),
                TreeNode.leetcodeOutput(impl.pruneTree(TreeNode.leetcodeInput("[1,0,1,0,0,0,1]"))));

        assertArrayEquals(CommonStr.parse2IntegerArray("[1,1,0,1,1,null,1]"),
                TreeNode.leetcodeOutput(impl.pruneTree(TreeNode.leetcodeInput("[1,1,0,1,1,0,1,0]"))));

        assertArrayEquals(CommonStr.parse2IntegerArray("[0,null,0,1,1,null,1,null,1]"),
